              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  <label for="currencyTo">
                    Convert to SEK (in {{ swedishCrowns }}):
                  </label>
                  <select
                    id="currencyTo"
                    class="form-control"
  ...
  export default {
    ...
    data() {
      return {
        ...
        conversionRate: null,
        swedishCrowns: null,
        myKey: "c80a34a0d72244519a17acc39635a90e",
      };
    },
    watch: {
      ...
      async convert() {
        try {
          const response = await axios.get(
            `https://openexchangerates.org/api/latest.json?app_id=${this.myKey}&base=${this.currencyType}&symbols=SEK`
          );
